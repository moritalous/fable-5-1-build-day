...
1. Choose `Fable` (Fable 5.1) from the list and press Enter.

    ![](../../preparation/images/2026-09-13-01-52-12.png)

1. Once you see "Set model to Fable 5.1 and saved as your default for new sessions", the switch is done. Fable 5.1 will be used automatically the next time you start it, too.

</Steps>

<Aside type="tip" title="You can switch models any time">
	You can change it any time while running with `/model`. If it feels slow, try switching to a lighter model like `Sonnet` or `Haiku`.
</Aside>
