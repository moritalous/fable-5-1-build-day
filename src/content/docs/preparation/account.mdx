...
<Aside type="caution" title="claude.aiのアカウントとは別物です">
	...
	すでにClaude Pro/Maxを契約している方も、クレジットを受け取るにはClaude Platformのアカウントが必要です（Claude CodeはPro/Maxのままでも使えます。詳しくは[3. 初回起動とログイン](/preparation/first-run/)を参照）。
</Aside>
