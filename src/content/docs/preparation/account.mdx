...
Build DayではClaude Codeを**APIクレジット**で動かします。そのために[Claude Platform](https://platform.claude.com)（開発者向けのコンソール。画面上の表示は「Claude Console」です）のアカウントが必要です。**イベント前に作成をお願いします**。所要時間は3分程度です。
